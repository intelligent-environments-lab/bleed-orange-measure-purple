...
class PAfiles:
    ...
    def find_purpleair_in_dir(parent_dir):
        ...
        return [parent_dir + '\\' + filename for filename in os.listdir(parent_dir)]
    ...
    def merge_data(files):
        ...
        for file in files:
            if (
                file.sensorname in condensed_set
            ):  # Check if file already and merge if true
