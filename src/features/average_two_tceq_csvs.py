...
Interstate = {'2018': pd.read_csv(f'{root}/2018 Interstate.csv'),
...
Webber = {'2018': pd.read_csv(f'{root}/2018 Webber pm2.5.csv'),
...
combined = {'2018': pd.concat([Interstate['2018'], Webber['2018']], axis=1).mean(axis=1),
