...
def shift_year_to_present(df, column='Time'):
    ...
    df[column] = df[column].apply(
        lambda s: s.replace('2018', '2020').replace('2019', '2020')
    )
    return df
...
def ozone_plot(root):
    ...
    def _import():
        return process_data(
            {'2020': pd.read_csv(f'{root}/2020 Edwards ozone.csv')}, column
        )
    ...
    label_plot(
        fig,
        'Ozone Levels in Austin 2018-2020',
        'Month of the Year',
...
def NOx_plot(root):
    ...
    def _import():
        return process_data(
            {'2020': pd.read_csv(f'{root}/2020 Interstate.csv')}, column
        )
    ...
    label_plot(
        fig,
        'NOx Levels in Austin 2018-2020',
        'Month of the Year',
...
def NO2_plot(root):
    ...
    label_plot(
        fig,
        'NO2 Levels in Austin 2018-2020',
        'Month of the Year',
